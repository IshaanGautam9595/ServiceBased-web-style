...
const Pricing = () => {
  return (
    <div name='pricing' className="w-full text-white my-24">
        ...
        <div className="text-center pu-8 text-slate-300">
            <h2 className="text-3xl uppercase">Pricing</h2>
            <h3 className="text-5xl font-bold text-white py-8">The right price for you.</h3>
            <p className="text-3xl">Lorem ipsum dolor sit amet, consectetur, adipiscing elit.  Cum socis natoque penatibus et justo asperiores earum placeat.</p>
        </div>
